...
<div class="radioButtons">
        ...
        <label class="container">Manual
          <input type="checkbox"  value="manual" class="chk2"  >
          <span class="checkmark"></span>
        </label>
        <label class="container">Automat
          <input type="checkbox"  value="automat" class="chk2">
          <span class="checkmark"></span>
        </label>
    </div>
    <div class="luggage">
    ...
    <c:forEach var="item" items="${AllCars.getCarReg()}">
			...
			<div class="priceButton">
				<h2>${item.price} SEK</h2>
					...
					<input type="text" name="status" hidden=true value="Logged">
					<button id="rent" class="w3-button w3-blue">Rent</button></form>

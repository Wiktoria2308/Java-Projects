...
<div class="imagecontainer">
      <div class="floatingtag3" >
      <h1>Who Are We ?</h1>
      <h3>
         Lorem ipsum dolor sit amet, consectetur
          adipiscing elit.
         Nunc maximus, nulla ut commodo sagittis, 
         sapien dui mattis dui, 
         non pulvinar lorem felis nec erat</h3>
      
         </div>
            <div class="sideBar">
               <ul>
                  
                   <li><a href="/GroupProject/CustomerProfile.jsp">Manage Your Profile</a></li>
                   <li><a href="/GroupProject/History.jsp">History</a></li>  
                   <li><a href="/GroupProject/LCreditCardInfo.jsp">Change Payment Information</a></li>
               </ul>
